...
class ProjectApp(basicApp.BasicApp):
    ...
    def buildPage(self):
        ...
        figure8 = basicFigures.getViolinPlot(data, variableCol = "Value", groupCol = "Group", colors = colors, identifier= "violin", title = "Violin plot", subplot = False)
        ...
        figure6 = basicFigures.getSankeyPlot(data, sourceCol ="source", targetCol = "target", weightCol = "weight", node_colors = colors, edgeColorCol = "edgeColor", identifier = "sankey", title = "This is a Sankey plot", subplot = False)
        self.addToLayout(figure6)
        
        figure7 = basicFigures.getBasicTable(data, identifier = "TableInteractions", title = "Table with Protein-protein interactions", colors = ('#C2D4FF','#F5F8FF'), subset = None, subplot = False)
