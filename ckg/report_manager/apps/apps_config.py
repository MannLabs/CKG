...
proteomicsPage = {"overview": [
    ("number_peptides_analytical_sample", [], ["basicBarPlot"],
     {"x_title": "Analytical sample", "y_title": "number of peptides"}),
    ...
    "stratification": [
        ("identified_proteins_sample_group",
         ["pca", "tsne", "umap"],
         ["scatterPlot"],
         {"imputation": True, "imputation_method": "Mixed", "x_title": "PC1", "y_title": "PC2", "components": 2,
          "perplexity": 40, "n_iter": 1000, "init": 'pca'})
    ],
    "regulation": [
        ("identified_proteins_sample_group_with_gene",
         ["ttest"],
         ["volcanoPlot", "basicTable"],
         {"imputation": True, "imputation_method": "Mixed", "alpha": 0.05, "drop_cols": ["sample", "gene_name"],
          "name": "name"})
    ],
    # "correlation":[
    #               ("identified_proteins_sample_group",
