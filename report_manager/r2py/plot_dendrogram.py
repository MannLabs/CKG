...
def plot_dendrogram(Z_dendrogram, orientation='bottom', labels=None,
                    colorscale=None, hovertext=None, color_threshold=None):

    dendrogram = _Dendrogram(Z_dendrogram, orientation, labels,
...
class _Dendrogram(object):
    ...
    def __init__(self, Z_dendrogram, orientation='bottom', labels=None, colorscale=None, hovertext=None,
        ...
        (dd_traces, xvals, yvals,
            ordered_labels, leaves) = self.get_dendrogram_traces(Z_dendrogram, colorscale,
                                                                 hovertext,
                                                                 color_threshold)
    ...
    def get_dendrogram_traces(self, Z_dendrogram, colorscale, hovertext, color_threshold):
