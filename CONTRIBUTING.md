...
Report bugs at [https://github.com/MannLabs/CKG/issues](https://github.com/MannLabs/CKG/issues).
...
The best way to send feedback is to file an issue at [https://github.com/MannLabs/CKG/issues](https://github.com/MannLabs/CKG/issues).
...
5. When you're done making changes, check that your changes pass the lint check:
...
* Provides command-line utilities that launch a dash app to browse projects, statistics and others, create new users, and import and load 
