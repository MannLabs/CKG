    ...
    for database in databases:
        ...
        if database.lower() == "internal":
            ...
            for qtype in result:
                ...
                stats.add(utils.buildStats(len(relationships), "relationships", qtype, database, outputfileName))
            ...
            stats.add(utils.buildStats(len(entities), "entity", "Publication", database, outputfileName))
            outputfile = os.path.join(importDirectory, outputfileName)
